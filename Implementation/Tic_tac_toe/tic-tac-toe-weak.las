...
does(player1, fill(coord(1,1)),3).
does(player2, fill(coord(3,3)),4).
does(player1, fill(coord(3,2)),5).}).

#brave_ordering(pos2, pos1).
#brave_ordering(pos2, pos3).
#brave_ordering(pos2, pos4).
#brave_ordering(pos2, pos5).



% language bias
#modeo(1,same_row(var(x),var(y)),(positive)).
#modeo(1,same_column(var(x),var(y)),(positive)).
#modeo(1,same_diagonal(var(x),var(y)),(positive)).
#modeo(1,holds(cell(var(x),const(pawn)),const(t)),(positive)).
#modeo(1,holds(cell(var(y),const(pawn)),const(t)),(positive)).
