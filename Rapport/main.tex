...
%TODO : How to represent patterns, how to combine them. Example of Five Field Kono

%TODO : example with images
...
\texttt{adjacent(bottom, blue, c1, c2)} $\bigwedge$ \texttt{diagonal\_collision(down\_right, empty, c1, c4)} $\bigwedge$ \texttt{diagonal\_collision(up\_right, red, c2, c4)}
\end{example}
...
%TODO : can play itself / evaluation very easy.
